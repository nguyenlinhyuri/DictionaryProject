...
public class DictionaryManagement {
    ...
    void insertFromFile() throws FileNotFoundException {
        File file = new File("E:\\Java\\intellijJava\\Dictionary\\src\\dictionaries.txt");
    ...
    void dictionaryExportToFile() throws IOException {
        FileWriter fileWriter = new FileWriter("E:\\Java\\intellijJava\\Dictionary\\src\\data.txt");
